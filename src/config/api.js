const API_CONST = {
  ...
  registerPhoneNumber: { url: `/wx-api/wx/auth/wxAuth/bindMobile`, method: "POST"  }, //绑定手机号码
  ...
  postGoodsCommentsLike: { url:`/wx-api/wx/goods/comments/like`, method: "POST" },
  ...
  getTimeUnits: { url: `/wx-api/wx/order/dada/availableTimeUnits`, method: "GET" }, // 获取线下配送时间颗粒度
  ...
  postExpressCompany: { url: `/wx-api/wx/order/express/company`, method: "POST" },
  getAsExpressInfo: { url: `/wx-api/wx/order/refund/expressInfo`, method: "GET"},
  ...
  // 优惠券
  getTicketDetail: { url: `/wx-api/wx/ticket/get_ticket_module_plan_scope`, method: "POST" }, // 获取优惠券详情
  postTicket: { url: `/wx-api/wx/ticket/get_user_ticket`, method: "POST" }, // 领取优惠券
  getTicketList: { url: `/wx-api/wx/ticket/ticket_detail_list`, method: "POST" }, // 获取优惠券列表
  getUserTickeList: { url: `/wx-api/wx/ticket/get_user_ticket_detail_list`, method: "POST"  }, //我的卷包
  getShopTicketList: { url: `/wx-api/wx/ticket/get_shop_can_use_ticket`, method: "POST" }, // 获取优惠券列表
  getTicketPlanList: { url: `/wx-api/wx/ticket/get_ticket_plan_list`, method: "POST" }, // 获取投放计划列表
  ...
  getPayRecommendGoodsList: { url: `/wx-api/wx/recommend/goods/list`, method: "GET" },
  ...
  // QrCode
  getGoodsQrCode: { url: `/wx-api/wx/wechat/getwxacodeunlimit`, method: "POST" },

  // trends word
  getTrendsWord: {url: `/wx-api/wx/trending/words`, method: "GET"},

  // Integral
  checkIntegral: {url: `/wx-api/wx/integral/countIntegralDeducMoney`, method: "POST"},
