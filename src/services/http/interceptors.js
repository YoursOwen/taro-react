...
const requestInterceptors = function(chain) {
  ...
  let Token = requestParams.headers['X-BfcMall-Token'] || Taro.getStorageSync('token')
...
const interceptors = [requestInterceptors, customInterceptor, Taro.interceptors.logInterceptor]
